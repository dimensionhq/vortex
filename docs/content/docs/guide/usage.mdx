...
To understand more about each layout, check out the [layout guide](/vortex/docs/layout/configuration).

For now, we'll be choosing the [default](/vortex/docs/layout/default) layout.
...
| **theme.codeBlockTheme**        | `true`   | [Supported Themes](/vortex/docs/customization/themes#supported-codeblock-themes) | `atomOneDark` |
