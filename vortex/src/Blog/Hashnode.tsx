...
import CDevTO, { Main, ReactionChild, Reactions } from "../components/Hashnode";
import { Author, Header, Title } from "../components/Hashnode/header";
...
import { Reaction } from "./components/Hashnode/Reaction";
            ...
            <Main {...props} theme={props.theme}>
                ...
                <div style={{ padding: "20px 40px", fontFamily: props.font?.title }}>
                    ...
                    {props.header?.subtitle ? (
                        <h4 style={{ font: props.font?.header, fontSize: "28px", margin: "0px", color: props.theme?.dateColor }}>{props.header.subtitle}</h4>
                    ) : <></>}
                    <Author theme={props.theme}>
                        <img width="58px" height="58px" style={{ borderRadius: "100%" }} src={props.author?.avatar} alt="" />
